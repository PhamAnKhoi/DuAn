...
//       try {
//         const response = await axios.get("http://nkduy.vn:88/api/post/25"); // Replace 25 with the actual post ID
...
//         "http://nkduy.vn:88/api/edit/25", // Replace 25 with the actual post ID
//         formData,
//         {
//           headers: {
...
//           Thumbnail: 
//           <br />
//           <img src={ thumbnail } alt="" width={200} style={{ objectFit: 'cover' }} />
//           <br />
//           <input
//             type="file"
